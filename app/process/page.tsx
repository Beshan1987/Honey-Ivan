...
export default function ProcessPage() {
  const processSteps = [
    ...
    },
    {
      ...
      description:
        "Мы регулярно осматриваем ульи, следят за здоровьем пчёл и создают оптимальные условия.",
      icon: "🐝",
    },
    {
      step: 3,
      ...
      <section className={styles.section}>
        <div className={styles.container}>
          ...
          <div className={styles.heroImage}>
            <Image src="/images/keeper.jpg" alt="Процесс производства мёда" width={800} height={400} />
          </div>
